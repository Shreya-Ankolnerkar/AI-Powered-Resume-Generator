...
const LandingPage = () => {
  return (
    <div className="bg-base-100">
      {/* Hero Section */}
      {/* Hero Section */}
    <section className="min-h-screen flex items-center justify-center text-white px-4 pt-24">
      {/* pt-24 = padding top to push below navbar */}
      <div className="text-center max-w-2xl">
        <h1 className="text-5xl font-extrabold leading-tight tracking-tight mb-6">
          Build a Smart Resume <br />
        ...
        <p className="text-lg text-gray-300 mb-10">
          Your next job is one resume away. Instantly generate professional,
          tailored resumes that stand out — in seconds.
        </p>

        <Link
          to="/generate-resume"
          
          className="inline-block bg-primary text-white px-6 py-3 text-base font-semibold rounded-md 
           hover:bg-primary-focus transition duration-200 shadow-sm hover:shadow-md 
      ...
      <section className="py-20 bg-base-100">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="card bg-base-200 shadow-md px-6 py-4 text-center max-w-md mx-auto">
  <h3 className="font-semibold text-lg">🤖 Smarter Resumes, Better Opportunities</h3>
  <p className="text-sm opacity-80">AI-powered resume generation made simple</p>
</div>
